...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string cipherPlainText(CommonRequest commonRequest, string plainText)")
...
func main() {
	...
	case "cipherPlainText":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "CipherPlainText requires 2 args")
			flag.Usage()
		}
		arg40 := flag.Arg(1)
		...
		value1 := argvalue1
		fmt.Print(client.CipherPlainText(value0, value1))
		fmt.Print("\n")
		break
	case "ping":
		if flag.NArg()-1 != 1 {
