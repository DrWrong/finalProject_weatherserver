...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string getCityWeatherInfo(CommonRequest commonRequest, CityWeatherInfoRequest cityInfo)")
...
func main() {
	...
	client := thrift_interface.NewCityWeatherInfoServiceClientFactory(trans, protocolFactory)
	...
	switch cmd {
	case "getCityWeatherInfo":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "GetCityWeatherInfo requires 2 args")
			flag.Usage()
		}
		arg17 := flag.Arg(1)
		...
		argvalue1 := thrift_interface.NewCityWeatherInfoRequest()
		...
		value1 := argvalue1
		fmt.Print(client.GetCityWeatherInfo(value0, value1))
		fmt.Print("\n")
		break
	case "ping":
		if flag.NArg()-1 != 1 {
