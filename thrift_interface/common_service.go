...
type CommonService interface {
	// Parameters:
	//  - CommonRequest
	Ping(commonRequest *CommonRequest) (r bool, err error)
}
...
func NewCommonServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *CommonServiceClient {
	return &CommonServiceClient{Transport: t,
		ProtocolFactory: f,
...
// Parameters:
//  - CommonRequest
func (p *CommonServiceClient) Ping(commonRequest *CommonRequest) (r bool, err error) {
	if err = p.sendPing(commonRequest); err != nil {
		return
	}
	return p.recvPing()
}

func (p *CommonServiceClient) sendPing(commonRequest *CommonRequest) (err error) {
	...
	args0 := NewPingArgs()
	args0.CommonRequest = commonRequest
...
func (p *CommonServiceClient) recvPing() (value bool, err error) {
...
func NewCommonServiceProcessor(handler CommonService) *CommonServiceProcessor {
	...
	self4 := &CommonServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self4.processorMap["ping"] = &commonServiceProcessorPing{handler: handler}
	return self4
}

func (p *CommonServiceProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
func (p *commonServiceProcessorPing) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := NewPingArgs()
	...
	if result.Success, err = p.handler.Ping(args.CommonRequest); err != nil {
